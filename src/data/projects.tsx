...
const projects: Project[] = [
  ...
  { // 03. Portfolio project
    ...
    category: "Portfolio",
    title: "My Portfolio",
    src: "/assets/projects-screenshots/portfolio_imgs/landing.png",
    screenshots: ["assets/projects-screenshots/portfolio_imgs/landing.png"],
    live: "#",
    github:"https://github.com/medox1trx/My-Portfolio-",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
    ...
    get content() {
      return (
        <div>
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/portfolio_imgs/landing.png`,
              `${BASE_PATH}/portfolio_imgs/skills.png`,
            ]}
          />
          <TypographyH3 className="my-4 ">Space Theme</TypographyH3>
          <p className="font-mono mb-2">
          ...
          <SlideShow images={[`${BASE_PATH}/portfolio_imgs/navbar.png`]} />
          <TypographyH3 className="my-4 mt-8">Projects</TypographyH3>
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/portfolio_imgs/projects.png`,
              `${BASE_PATH}/portfolio_imgs/project.png`,
            ]}
          />
          <p className="font-mono mb-2 mt-8 text-center">
            This site&apos;s not just a portfolio — it&apos;s a whole vibe.
